     ...
     <div class="card mb-4">
      ...
      <div class="card-body">
       ...
       <card class="mb-4">
        ...
        <div class="profile">
         <div class="avatar">
          <img src="../actions/images/<?php echo $row['photo']; ?>" class="img-raised rounded-circle " width="200px"
           height="200px" alt="">
         </div>
        </div>
       </card>
          ...
          <div class="card-body">
           <form action="../actions/pw_update.php" method="post">
            ...
            <div class="mb-3">
             ...
             <input type="email" name="email" r id="email" class="form-control" value="<?= $user_email?>">
            </div>
            <div class="mb-3">
