       ...
       <table id="datatablesSimple">
        ...
        <tbody>
         <?php
          ...
          // get all post
          $sql = "SELECT posts.*, users.username AS name, categories.categories_name AS cat_name FROM posts LEFT JOIN users ON posts.user_id = users.id LEFT JOIN categories ON posts.category_id = categories.id";
         ...
         <tr>
          ...
          <td><img src="../actions/post_photo/<?= $row['file_name'] ?>" alt="" width="60px"></td>
          <td>
           <a href="post_edit_form.php?id=<?= $row['id'] ?>" class="btn btn-outline-primary"><i
             class="fa-regular fa-user-pen"></i></a>
